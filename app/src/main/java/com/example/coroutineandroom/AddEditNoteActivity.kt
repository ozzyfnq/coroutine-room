...
class AddEditNoteActivity : AppCompatActivity() {
    companion object {
        const val EXTRA_ID = "com.example.coroutineandroom.EXTRA_ID"
        const val EXTRA_JUDUL = "com.example.coroutineandroom.EXTRA_JUDUL"
        const val EXTRA_DESKRIPSI = "com.example.coroutineandroom.EXTRA_DESKRIPSI"
        const val EXTRA_PRIORITAS = "com.example.coroutineandroom.EXTRA_PRIORITAS"
        const val EXTRA_NOMORTELP = "com.example.coroutineandroom.EXTRA_NOMORTELP"
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent.hasExtra(EXTRA_ID)) {
            ...
            edit_text_phone.setText(intent.getStringExtra(EXTRA_NOMORTELP))
    ...
    private fun saveNote() {
        ...
        val data = Intent().apply {
            ...
            putExtra(EXTRA_NOMORTELP, edit_text_phone.text.toString())
